                            ...
                            <div class="rj-post-content">                                   
                                ...
                                if (!empty($pdf_data)) {
                                    ...
                                    foreach ($pdf_data as $item) { ?>    
                                        <?php echo '<li class="new-vendor-pdfs">'; 
                                                get_template_part('template-parts/aspire-icon');
                                            echo '<a href="' . esc_url($item['url']) . '" target="_blank">' . esc_html($item['title']) . '</a></li>';
                                    }
                                    echo '</ul>';
                                }
                                ?>
                                ...
                                <a href="<?php echo get_the_permalink(); ?>" title="<?php echo esc_attr(get_the_title()); ?>" class="rj-read-more">
                                    <?php echo esc_html('Learn More', 'astra-child'); ?>
                                </a>
